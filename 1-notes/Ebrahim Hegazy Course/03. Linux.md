...
<img src="Images/find-examples.png" alt="Find command examples" width="600">
...
Read [](https://www.howtogeek.com/435903/what-are-stdin-stdout-and-stderr-on-linux/#:~:text=In%20Linux%2C%20stdin%20is%20the,stderr%20(standard%20error)%20stream.)
...
- Optional: [Redhat Red Hat Certified System Administrator RHCSA 8,9](https://www.youtube.com/playlist?list=PLMYF6NkLrdN-ISNyZ5sEBv-c4ikGeoeV0) .

---
#### More:
- Read [Linux distributions - Wikipedia](https://en.wikipedia.org/wiki/Linux_distribution)
- Read https://en.wikipedia.org/wiki/Linux_distribution#/media/File:2023_Linux_Distributions_Timeline.svg