...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `~/.config/opencode/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=~/.config/opencode/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=~/.config/opencode/commands/gsd
...
<execution_context>
Surface state file: `~/.config/opencode/skills/.gsd-surface.json`
Install profile marker: `~/.config/opencode/skills/.gsd-profile`
Engine module: `~/.config/opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `~/.config/opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
