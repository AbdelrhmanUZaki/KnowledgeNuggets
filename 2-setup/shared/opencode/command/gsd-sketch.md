...
<execution_context>
@~/.config/opencode/get-shit-done/workflows/sketch.md
@~/.config/opencode/get-shit-done/workflows/sketch-wrap-up.md
@~/.config/opencode/get-shit-done/references/ui-brand.md
@~/.config/opencode/get-shit-done/references/sketch-theme-system.md
@~/.config/opencode/get-shit-done/references/sketch-interactivity.md
@~/.config/opencode/get-shit-done/references/sketch-tooling.md
@~/.config/opencode/get-shit-done/references/sketch-variant-patterns.md
</execution_context>
