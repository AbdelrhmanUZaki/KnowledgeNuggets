...
<execution_context>
@~/.config/opencode/get-shit-done/workflows/import.md
@~/.config/opencode/get-shit-done/references/ui-brand.md
@~/.config/opencode/get-shit-done/references/gate-prompts.md
@~/.config/opencode/get-shit-done/references/doc-conflict-engine.md
</execution_context>
...
Run: `node "~/.config/opencode/get-shit-done/bin/gsd-tools.cjs" from-gsd2`
