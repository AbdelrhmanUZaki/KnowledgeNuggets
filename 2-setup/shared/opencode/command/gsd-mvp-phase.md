...
<execution_context>
@~/.config/opencode/get-shit-done/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @~/.config/opencode/get-shit-done/workflows/mvp-phase.md end-to-end.
