...
```markdown
Read ~/.config/opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: ~/.config/opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read ~/.config/opencode/agents/gsd-ui-checker.md for instructions.
