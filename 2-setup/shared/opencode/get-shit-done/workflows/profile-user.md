...
Key references:
- @~/.config/opencode/get-shit-done/references/ui-brand.md (display patterns)
- @~/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @~/.config/opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="~/.config/opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "~/.config/opencode/get-shit-done/USER-PROFILE.md" "~/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at ~/.config/opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `~/.config/opencode/get-shit-done/references/user-profiling.md`
...
Reference: @~/.config/opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to ~/.config/opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to ~/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at ~/.config/opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at ~/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to ~/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="~/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    ~/.config/opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   ~/.config/opencode/skills/gsd-dev-preferences/SKILL.md
