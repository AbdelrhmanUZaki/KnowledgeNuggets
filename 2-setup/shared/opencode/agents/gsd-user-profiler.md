...
<reference>
@~/.config/opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `~/.config/opencode/get-shit-done/references/user-profiling.md` to load:
