...
<required_reading>
@~/.config/opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@~/.config/opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks ~/.config/opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ~/.config/opencode/get-shit-done
                  → writes to ~/.config/opencode/get-shit-done/hooks/
...
@~/.config/opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @~/.config/opencode/get-shit-done/references/common-bug-patterns.md
